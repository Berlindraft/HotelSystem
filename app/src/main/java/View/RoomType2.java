 ...
 * @author marvi
 */
public class RoomType2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoomType2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
